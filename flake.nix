{
  ...
  inputs = {
    ...
    kitsune2 = {
      url = "github:holochain/kitsune2?ref=v0.5.0-dev.6";
      flake = false;
    };

    # Holochain sources
    holochain = {
      url = "github:holochain/holochain?ref=holochain-0.7.0-rc.5";
      flake = false;
    };
    ...
    hc-scaffold = {
      url = "github:holochain/scaffolding?ref=v0.700.0-rc.0";
      flake = false;
    };
  };
