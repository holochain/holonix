{
  ...
  inputs = {
    ...
    # Holochain sources
    holochain = {
      url = "github:holochain/holochain?ref=holochain-0.2.8";
      flake = false;
    };

    # Lair keystore sources
    lair-keystore = {
      url = "github:holochain/lair?ref=lair_keystore-v0.4.2";
      flake = false;
    };

    # Holochain Launch CLI
    hc-launch = {
      url = "github:holochain/hc-launch?ref=holochain-0.2";
      flake = false;
    };

    hc-scaffold = {
      url = "github:holochain/scaffolding?ref=holochain-0.2";
      flake = false;
    };
  };
