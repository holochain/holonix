{
  ...
  inputs = {
    ...
    kitsune2 = {
      url = "github:holochain/kitsune2?ref=v0.4.0-dev.10";
      flake = false;
    };

    # Holochain sources
    holochain = {
      url = "github:holochain/holochain?ref=holochain-0.6.1-rc.8";
      flake = false;
    };
    ...
    hc-scaffold = {
      url = "github:holochain/scaffolding?ref=v0.600.3-rc.0";
      flake = false;
    };
  };
